...
│
├── 📁 dags/
│   ├── 🕒 daily_fraud_report_dag.py             # Scheduled daily fraud reporting
│   └── 🎯 daily_fraud_detection_demo_dag.py     # Manual trigger demo DAG
│
├── 📁 dashboard/
...
│
├── 📁 logs/
│   ├── dag_id=*/                                # Airflow DAG logs (Docker managed)
│   ├── dag_processor_manager/                   # Airflow processor logs
